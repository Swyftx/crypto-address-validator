...
describe('WAValidator.validate()', function () {
  describe('valid results', function () {
    it('should return true for correct bitcoin addresses', function () {
      ...
      invalid('BC13W508D6QEJXTDG4Y5R3ZARletY0C5XW7KN40WF2', 'bitcoin')
      invalid('bc1rw5uspcuh', 'bitcoin')
      invalid('bc10w508d6qejxtdg4y5r3zarlety0c5xw7kw508d6qejxtdg4y5r3zarlety0c5xw7kw5rljs90', 'bitcoin')
      invalid('BC1QR508D6QEJXTDG4Y5R3ZARletYV98GJ9P', 'bitcoin')
      invalid('tb1qrp33g0q5c5txsp9arysrx4k6zdkfs4nce4xj0gdcccefvpysxf3q0sL5k7', 'bitcoin')
      invalid('bc1zw508d6qejxtdg4y5r3zarletyvqyzf3du', 'bitcoin')
