...
const valid = (
  ...
  const result = WAValidator.validate(
    address,
    currency,
    networkType,
    addressFormats
...
describe("WAValidator.validate()", () => {
  it("Validator not found", () => {
    const notExistingValidatorName = 'ShouldNotExist'
    try {
      WAValidator.validate(
        'EJnMhXdyhaqADoK1N5MIL4FtZ27DvFDFvVw', // random string
        notExistingValidatorName,
      );
    } catch(error) {
      expect((error as Error).message).to.be.equal(`Missing validator for currency: ${notExistingValidatorName}`)
    }
  })
  ...
  describe("valid results", () => {
    ...
    it("should return true for correct bitcoincash addresses", () => {
      ...
      // SLP addresses
      valid(
        "pp8skudq3x5hzw8ew7vzsw8tn4k8wxsqsvryq5wf0k",
        "bitcoincash",
        NetTypes.both,
        [AddressFormats.all]
      );
    ...
    it("should return true for correct Garlicoin addresses", () => {
      ...
      valid(
        "mjKbQTkgwzmsL3J86tdVzhyW9pc4NePqTb",
        "garlicoin",
        NetTypes.testnet
      );
    ...
    it("should return true for correct zencash/horizen addresses", () => {
    ...
    it("should return true for correct Siacoin addresses", () => {
      valid(
        "1acc2bc035b6606bd612b6114efea1102bd4499c0edf559469de7f40076f1c54e4eed3c5f1ac",
        "sc"
      );
    });
  ...
  describe("invalid results", () => {
    ...
    it("should return false for incorrect bitcoincash addresses", () => {
      ...
      invalid("12QeMLzSrB8XH8FvEzPMVoRxVAzTr5XM2y", "bch", NetTypes.both, [
        AddressFormats.unknown,
      ]);
    });
    ...
    it("should return false for incorrect Stellar Lumens addresses", () => {
      invalid(
        "GAHK7EEG2WWHVKDNT4CEQDZGKF2LGDSW2IVM4S5DP42RBW3K6BTODB4A",
        "xlm"
      );
    });
    ...
    it("should return false for incorrect Siacoin addresses", () => {
      invalid(
        "1acc2bc035b6606bd612b6114efea1102bd4499c0edf559469de7f40076f1c54e4eed3c5f1a",
        "sc"
      );
      invalid(
        "1acc2bc035b6606bd612b6114efea1102bd4499c0edf559469de7f40076f1c54e4eed3c5f1ah",
        "sc"
      );
    });
